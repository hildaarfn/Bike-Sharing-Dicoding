...
# Load data
day_df = pd.read_csv('D:\KULIAH\SERTIFIKAT\DICODING\Dashboard\day_data.csv')  
hour_df = pd.read_csv('D:\KULIAH\SERTIFIKAT\DICODING\Dashboard\hour_data.csv')  
...
question = st.selectbox(
    "Pilih informasi:"
    [
        "Perubahan jumlah pengguna sepeda di setiap musim (season)?",
        "Waktu (jam) penyewaan sepeda tertinggi dalam pada tahun 2011 dan 2012?"
    ]
)

if question == "perubahan jumlah pengguna sepeda di setiap musim (season)?":
...
elif question == "Waktu (jam) penyewaan sepeda tertinggi dalam pada tahun 2011 dan 2012?":
